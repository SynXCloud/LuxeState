...
function openModal(id){
  ...
  document.getElementById('modalInner').innerHTML=`
    <div class="modal-gallery">
      <div class="gallery-main"><div style="width:100%;height:100%;background:var(--surface2);display:flex;align-items:center;justify-content:center;font-size:80px">${p.emoji}</div></div>
      <div class="gallery-subs">
        <div class="gallery-sub"><div style="width:100%;height:100%;background:var(--surface3);display:flex;align-items:center;justify-content:center;font-size:40px;opacity:0.6">${p.emoji}</div></div>
        <div class="gallery-sub"><div style="width:100%;height:100%;background:var(--surface3);display:flex;align-items:center;justify-content:center;font-size:40px;opacity:0.4">${p.emoji}</div></div>
      </div>
    </div>
...
function buildCompareTable(){
  ...
  let html=`<div class="compare-row header" style="grid-template-columns:${colTmpl}">
    ...
    ${compareList.map(p=>`<div class="compare-cell"><strong style="font-family:'Cormorant Garamond',serif;font-size:18px">${p.emoji} ${p.name}</strong></div>`).join('')}
  </div>`;
  fields.forEach(f=>{
